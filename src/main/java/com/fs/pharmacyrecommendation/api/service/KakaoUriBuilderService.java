...
public class KakaoUriBuilderService {
    ...
    public URI buildUriByAddressSearch(String address) {
        UriComponentsBuilder uriBuilder = UriComponentsBuilder.fromHttpUrl(KAKAO_LOCAL_SEARCH_ADDRESS_URL) // 주소를 받아옴
                .queryParam("query", address); // query 파라미터 추가

        URI uri = uriBuilder.build().encode().toUri(); // 한글 주소를 인코딩
